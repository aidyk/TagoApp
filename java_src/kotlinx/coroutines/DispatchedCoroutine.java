...
public final class DispatchedCoroutine<T> extends ScopeCoroutine<T> {
    ...
    @Override // kotlinx.coroutines.AbstractCoroutine, kotlinx.coroutines.JobSupport, kotlinx.coroutines.internal.ScopeCoroutine
