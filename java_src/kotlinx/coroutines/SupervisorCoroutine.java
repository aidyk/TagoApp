...
final class SupervisorCoroutine<R> extends AbstractCoroutine<R> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: kotlin.coroutines.Continuation<? super R> */
