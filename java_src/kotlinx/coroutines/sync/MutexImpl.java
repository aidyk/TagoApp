...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        public void complete(@NotNull AtomicOp<?> atomicOp, @Nullable Object obj) {
            ...
            if (obj != null) {
                ...
                empty = this.owner == null ? MutexKt.EmptyLocked : new Empty(this.owner);
            }
    ...
    public boolean holdsLock(@NotNull Object obj) {
        ...
        Object obj2 = this._state;
        if (obj2 instanceof Empty) {
            return ((Empty) obj2).locked == obj;
        }
        if (!(obj2 instanceof LockedQueue) || ((LockedQueue) obj2).owner != obj) {
            return false;
        }
    }
    ...
    private static final class LockSelect<R> extends LockWaiter {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: kotlin.jvm.functions.Function2<? super kotlinx.coroutines.sync.Mutex, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> */
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public LockSelect(@Nullable Object obj, @NotNull Mutex mutex2, @NotNull SelectInstance<? super R> selectInstance, @NotNull Function2<? super Mutex, ? super Continuation<? super R>, ? extends Object> function2) {
            super(obj);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x007f A[LOOP_START] */
    @org.jetbrains.annotations.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final /* synthetic */ java.lang.Object lockSuspend(@org.jetbrains.annotations.Nullable java.lang.Object r18, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r19) {
        /*
