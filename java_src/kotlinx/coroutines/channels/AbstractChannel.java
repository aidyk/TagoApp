...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    private final boolean enqueueReceive(kotlinx.coroutines.channels.Receive<? super E> r7) {
        /*
    ...
    @Override // kotlinx.coroutines.channels.ReceiveChannel, kotlinx.coroutines.channels.ReceiveChannel
    public void cancel() {
        cancel(null);
    }
                ...
                if (!getChannel().enqueueReceive(receiveHasNext2)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    public static final class ReceiveElement<E> extends Receive<E> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: kotlinx.coroutines.CancellableContinuation<? super E> */
        /* JADX WARN: Multi-variable type inference failed */
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m4constructorimpl(null));
        }
    ...
    public final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: kotlin.jvm.functions.Function2<? super E, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> */
        /* JADX WARN: Multi-variable type inference failed */
        ...
        while (true) {
            ...
            if (!enqueueReceive(receiveElement2)) {
                ...
                if (!(pollInternal instanceof Closed)) {
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        Result.Companion companion = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(pollInternal));
                        break;
                    }
                } else {
        ...
        while (true) {
            ...
            if (!enqueueReceive(receiveElement2)) {
                ...
                if (!(pollInternal instanceof Closed)) {
                    ...
                    if (closed.closeCause == null) {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(null));
                    } else {
                        Throwable th = closed.closeCause;
                        Result.Companion companion3 = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m4constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
                cancellableContinuationImpl2.initCancellability();
