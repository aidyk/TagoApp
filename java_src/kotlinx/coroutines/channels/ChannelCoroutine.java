...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    @Override // kotlinx.coroutines.Job, kotlinx.coroutines.Job, kotlinx.coroutines.JobSupport, kotlinx.coroutines.JobSupport, kotlinx.coroutines.channels.ReceiveChannel, kotlinx.coroutines.channels.ReceiveChannel
    public void cancel() {
        cancel(null);
    }

    /* renamed from: cancel0 */
