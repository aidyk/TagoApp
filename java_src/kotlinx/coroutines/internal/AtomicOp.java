...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    public final boolean tryDecide(@Nullable Object obj) {
        if (obj != AtomicKt.access$getNO_DECISION$p()) {
            return _consensus$FU.compareAndSet(this, AtomicKt.access$getNO_DECISION$p(), obj);
        }
    ...
    public final Object perform(@Nullable Object obj) {
        ...
        if (obj2 == AtomicKt.access$getNO_DECISION$p()) {
