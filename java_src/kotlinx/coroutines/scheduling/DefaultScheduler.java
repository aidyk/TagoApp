...
public final class DefaultScheduler extends ExperimentalCoroutineDispatcher {
    ...
    static {
        ...
        IO = defaultScheduler.blocking(SystemPropsKt.systemProp$default(DispatchersKt.IO_PARALLELISM_PROPERTY_NAME, RangesKt.coerceAtLeast(64, SystemPropsKt.getAVAILABLE_PROCESSORS()), 0, 0, 12, (Object) null));
    }
    ...
    @Override // kotlinx.coroutines.scheduling.ExperimentalCoroutineDispatcher, java.io.Closeable, kotlinx.coroutines.ExecutorCoroutineDispatcher, java.lang.AutoCloseable
    public void close() {
