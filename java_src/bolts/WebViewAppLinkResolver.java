...
public class WebViewAppLinkResolver implements AppLinkResolver {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x011c, code lost:
        if (java.util.Arrays.asList("no", "false", com.facebook.appevents.AppEventsConstants.EVENT_PARAM_VALUE_NO).contains(((java.lang.String) ((java.util.Map) r14.get(0)).get(bolts.WebViewAppLinkResolver.KEY_AL_VALUE)).toLowerCase()) != false) goto L_0x0120;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
