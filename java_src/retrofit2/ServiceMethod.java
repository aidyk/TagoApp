...
public final class ServiceMethod<R, T> {
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: retrofit2.CallAdapter<T, R>, retrofit2.CallAdapter<R, T> */
    /* JADX DEBUG: Type inference failed for r0v5. Raw type applied. Possible types: retrofit2.Converter<okhttp3.ResponseBody, T>, retrofit2.Converter<okhttp3.ResponseBody, R> */
    ServiceMethod(Builder<R, T> builder) {
        this.callFactory = builder.retrofit.callFactory();
        this.callAdapter = (CallAdapter<T, R>) builder.callAdapter;
        this.baseUrl = builder.retrofit.baseUrl();
        this.responseConverter = (Converter<ResponseBody, T>) builder.responseConverter;
