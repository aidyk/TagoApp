...
public class CustomTabsClient {
    ...
    public static boolean connectAndInitialize(Context context, String str) {
        ...
        try {
            return bindCustomTabsService(applicationContext, str, new CustomTabsServiceConnection() {
                /* class android.support.customtabs.CustomTabsClient.AnonymousClass1 */
    ...
    public CustomTabsSession newSession(final CustomTabsCallback customTabsCallback) {
        AnonymousClass2 r0 = new ICustomTabsCallback.Stub() {
            /* class android.support.customtabs.CustomTabsClient.AnonymousClass2 */
            ...
            public void onNavigationEvent(final int i, final Bundle bundle) {
                if (customTabsCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class android.support.customtabs.CustomTabsClient.AnonymousClass2.AnonymousClass1 */
            ...
            public void extraCallback(final String str, final Bundle bundle) throws RemoteException {
                if (customTabsCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class android.support.customtabs.CustomTabsClient.AnonymousClass2.AnonymousClass2 */
            ...
            public void onMessageChannelReady(final Bundle bundle) throws RemoteException {
                if (customTabsCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class android.support.customtabs.CustomTabsClient.AnonymousClass2.AnonymousClass3 */
            ...
            public void onPostMessage(final String str, final Bundle bundle) throws RemoteException {
                if (customTabsCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class android.support.customtabs.CustomTabsClient.AnonymousClass2.AnonymousClass4 */
            ...
            public void onRelationshipValidationResult(final int i, final Uri uri, final boolean z, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class android.support.customtabs.CustomTabsClient.AnonymousClass2.AnonymousClass5 */
