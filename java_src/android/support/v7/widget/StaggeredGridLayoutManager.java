        ...
        if (!(getChildCount() == 0 || i == 0)) {
            ...
            for (int i5 = 0; i5 < this.mSpanCount; i5++) {
                if (this.mLayoutState.mItemDirection == -1) {
                    i3 = this.mLayoutState.mStartLine - this.mSpans[i5].getStartLine(this.mLayoutState.mStartLine);
                } else {
                    i3 = this.mSpans[i5].getEndLine(this.mLayoutState.mEndLine) - this.mLayoutState.mEndLine;
                }
                if (i3 >= 0) {
                    this.mPrefetchDistances[i4] = i3;
                    i4++;
                }
            }
            Arrays.sort(this.mPrefetchDistances, 0, i4);
            for (int i6 = 0; i6 < i4 && this.mLayoutState.hasMore(state); i6++) {
