...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        return new StaticLayout(charSequence, this.mTextPaint, charSequence != null ? (int) Math.ceil((double) Layout.getDesiredWidth(charSequence, this.mTextPaint)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
