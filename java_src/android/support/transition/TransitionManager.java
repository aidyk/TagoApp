    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.addListener(new TransitionListenerAdapter() {
                /* class android.support.transition.TransitionManager.MultiListener.AnonymousClass1 */

                @Override // android.support.transition.Transition.TransitionListener, android.support.transition.TransitionListenerAdapter
