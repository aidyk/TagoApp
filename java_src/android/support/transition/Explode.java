...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        return TranslationAnimationCreator.createAnimation(view, transitionValues2, rect.left, rect.top, translationX + ((float) this.mTempLoc[0]), translationY + ((float) this.mTempLoc[1]), translationX, translationY, sDecelerate);
    }
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        calculateOut(viewGroup, rect, this.mTempLoc);
        return TranslationAnimationCreator.createAnimation(view, transitionValues, i, i2, translationX, translationY, f2 + ((float) this.mTempLoc[0]), f + ((float) this.mTempLoc[1]), sAccelerate);
    }
