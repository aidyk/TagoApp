                ...
                synchronized (sLock) {
                    ...
                    sBackgroundThread.postAndReply(r1, new SelfDestructiveThread.ReplyCallback<TypefaceResult>() {
                        ...
                        public void onReply(android.support.v4.provider.FontsContractCompat.TypefaceResult r5) {
                            /*
                                r4 = this;
                                java.lang.Object r0 = android.support.v4.provider.FontsContractCompat.sLock
                                monitor-enter(r0)
                                android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r1 = android.support.v4.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x002d }
                                ...
                                return
                            L_0x0011:
                                android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r2 = android.support.v4.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x002d }
