...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @NonNull double[] dArr) {
        ...
        if (dArr.length == 3) {
            ...
            dArr[0] = ((0.4124d * pow) + (0.3576d * pow2) + (0.1805d * d)) * XYZ_WHITE_REFERENCE_Y;
            dArr[1] = ((0.2126d * pow) + (0.7152d * pow2) + (0.0722d * d)) * XYZ_WHITE_REFERENCE_Y;
            dArr[2] = ((pow * 0.0193d) + (pow2 * 0.1192d) + (d * 0.9505d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
