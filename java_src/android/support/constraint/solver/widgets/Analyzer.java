...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        int i13 = z2 ? i2 - i6 : i2;
        int margin = (constraintWidget.mListAnchors[i4].getMargin() * i8) + getParentBiasOffset(constraintWidget, i);
        int i14 = i13 + margin;
        int width2 = (i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8;
        Iterator it2 = constraintWidget.mListAnchors[i4].getResolutionNode().dependents.iterator();
        while (it2.hasNext()) {
            i12 = Math.max(i12, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it2.next())).myAnchor.mOwner, i, z, i14));
        }
        int i15 = 0;
        for (Iterator it3 = constraintWidget.mListAnchors[i7].getResolutionNode().dependents.iterator(); it3.hasNext(); it3 = it3) {
            i15 = Math.max(i15, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it3.next())).myAnchor.mOwner, i, z, width2 + i14));
        }
        if (z2) {
            i12 -= i6;
            width = i15 + i5;
        } else {
            width = i15 + ((i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8);
        }
        int i16 = 1;
        if (i == 1) {
            ...
            while (it4.hasNext()) {
                ...
                if (i8 == i16) {
                    i17 = Math.max(i17, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, i6 + i14));
                    i11 = i7;
                } else {
                    i11 = i7;
                    i17 = Math.max(i17, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (i5 * i8) + i14));
                }
                it4 = it4;
                i7 = i11;
                i16 = 1;
            ...
            i9 = i7;
            i10 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i17 : i8 == 1 ? i17 + i6 : i17 - i5;
        } else {
            i9 = i7;
            i10 = 0;
        }
        ...
        if (z) {
            ...
            constraintWidget.setFrame(i14, i18, i);
        } else {
        ...
        if (constraintWidget.mListAnchors[i4].mTarget != null && constraintWidget.mListAnchors[i9].mTarget != null && constraintWidget.mListAnchors[i4].mTarget.mOwner == (parent = constraintWidget.getParent()) && constraintWidget.mListAnchors[i9].mTarget.mOwner == parent) {
            constraintWidget.mBelongingGroup.addWidgetsToSet(constraintWidget, i);
        }
        return max;
    }
    ...
    private static int resolveDimensionRatio(ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (constraintWidget.mDimensionRatioSide == 1) {
                i = (int) (((float) constraintWidget.getWidth()) * constraintWidget.mDimensionRatio);
            } else {
                i = (int) (((float) constraintWidget.getWidth()) / constraintWidget.mDimensionRatio);
            }
