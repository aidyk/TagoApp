...
public class EndianUtils {
    ...
    public static short readSwappedShort(byte[] bArr, int i) {
        return (short) (((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8));
    }

    public static int readSwappedUnsignedShort(byte[] bArr, int i) {
        return ((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8);
    }
    ...
    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return (((long) (bArr[i + 3] & UByte.MAX_VALUE)) << 24) + (((long) (((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8) + ((bArr[i + 2] & UByte.MAX_VALUE) << 16))) & 4294967295L);
    }
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        return (((long) (((((bArr[i + 4] & UByte.MAX_VALUE) << 0) + ((bArr[i + 5] & UByte.MAX_VALUE) << 8)) + ((bArr[i + 6] & UByte.MAX_VALUE) << 16)) + ((bArr[i + 7] & UByte.MAX_VALUE) << 24))) << 32) + (((long) (((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8) + ((bArr[i + 2] & UByte.MAX_VALUE) << 16) + ((bArr[i + 3] & UByte.MAX_VALUE) << 24))) & 4294967295L);
    }
