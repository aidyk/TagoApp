...
public class XmlStreamReader extends Reader {
    ...
    public String calculateRawEncoding(String str, String str2, String str3) throws IOException {
        if (str == null) {
            return (str2 == null || str3 == null) ? this.defaultEncoding == null ? "UTF-8" : this.defaultEncoding : (!str3.equals("UTF-16") || (!str2.equals("UTF-16BE") && !str2.equals("UTF-16LE"))) ? str3 : str2;
        }
        if (str.equals("UTF-8")) {
