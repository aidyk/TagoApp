...
public class StringUtils {
    ...
    public static String substringAfterLast(String str, String str2) {
        ...
        return (isEmpty(str2) || (lastIndexOf = str.lastIndexOf(str2)) == -1 || lastIndexOf == str.length() - str2.length()) ? "" : str.substring(lastIndexOf + str2.length());
    }
    ...
    public static String[] substringsBetween(String str, String str2, String str3) {
        ...
        int i2 = 0;
        while (i2 < length - length2 && (r5 = str.indexOf(str2, i2)) >= 0 && (indexOf = str.indexOf(str3, (i = r5 + length3))) >= 0) {
    ...
    public static String center(String str, int i, char c) {
        ...
        return rightPad(leftPad(str, length + (length2 / 2), c), i, c);
    }
                ...
                while (i6 <= length2) {
                    ...
                    while (max <= i2) {
                        ...
                        if (charSequence3.charAt(i7) == charAt) {
                            ...
                            iArr4[max] = Math.min(Math.min(iArr4[i7], iArr3[max]), iArr3[i7]) + 1;
                        }
                        max++;
                    }
                    i6++;
    ...
    public static double getJaroWinklerDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        double commonPrefixLength = (double) commonPrefixLength(charSequence, charSequence2);
        Double.isNaN(commonPrefixLength);
        double round = (double) Math.round((score + (commonPrefixLength * 0.1d * (1.0d - score))) * 100.0d);
        Double.isNaN(round);
        return round / 100.0d;
    }
    ...
    private static double score(CharSequence charSequence, CharSequence charSequence2) {
        ...
        String setOfMatchingCharacterWithin = getSetOfMatchingCharacterWithin(str2, str, length);
        String setOfMatchingCharacterWithin2 = getSetOfMatchingCharacterWithin(str, str2, length);
        ...
        double length2 = (double) setOfMatchingCharacterWithin.length();
        double length3 = (double) str2.length();
        Double.isNaN(length2);
        Double.isNaN(length3);
        double d = length2 / length3;
        double length4 = (double) setOfMatchingCharacterWithin2.length();
        double length5 = (double) str.length();
        Double.isNaN(length4);
        Double.isNaN(length5);
        double length6 = (double) (setOfMatchingCharacterWithin.length() - transpositions);
        double length7 = (double) setOfMatchingCharacterWithin.length();
        Double.isNaN(length6);
        Double.isNaN(length7);
        return ((d + (length4 / length5)) + (length6 / length7)) / 3.0d;
    }
