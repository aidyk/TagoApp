...
public class _LinearLayout extends LinearLayout {
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_LinearLayout _linearlayout, View view, int i, int i2, float f, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
