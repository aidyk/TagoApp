...
public final class C$$Anko$Factories$Sdk15ViewGroup {
    @NotNull
    private static final Function1<Context, _AbsoluteLayout> ABSOLUTE_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$ABSOLUTE_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _AppWidgetHostView> APP_WIDGET_HOST_VIEW = C$$Anko$Factories$Sdk15ViewGroup$APP_WIDGET_HOST_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _FrameLayout> FRAME_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$FRAME_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _Gallery> GALLERY = C$$Anko$Factories$Sdk15ViewGroup$GALLERY$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _GridLayout> GRID_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$GRID_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _GridView> GRID_VIEW = C$$Anko$Factories$Sdk15ViewGroup$GRID_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _HorizontalScrollView> HORIZONTAL_SCROLL_VIEW = C$$Anko$Factories$Sdk15ViewGroup$HORIZONTAL_SCROLL_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _ImageSwitcher> IMAGE_SWITCHER = C$$Anko$Factories$Sdk15ViewGroup$IMAGE_SWITCHER$1.INSTANCE;
    public static final C$$Anko$Factories$Sdk15ViewGroup INSTANCE = new C$$Anko$Factories$Sdk15ViewGroup();
    @NotNull
    private static final Function1<Context, _LinearLayout> LINEAR_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$LINEAR_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _RadioGroup> RADIO_GROUP = C$$Anko$Factories$Sdk15ViewGroup$RADIO_GROUP$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _RelativeLayout> RELATIVE_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$RELATIVE_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _ScrollView> SCROLL_VIEW = C$$Anko$Factories$Sdk15ViewGroup$SCROLL_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _TableLayout> TABLE_LAYOUT = C$$Anko$Factories$Sdk15ViewGroup$TABLE_LAYOUT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _TableRow> TABLE_ROW = C$$Anko$Factories$Sdk15ViewGroup$TABLE_ROW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _TextSwitcher> TEXT_SWITCHER = C$$Anko$Factories$Sdk15ViewGroup$TEXT_SWITCHER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _ViewAnimator> VIEW_ANIMATOR = C$$Anko$Factories$Sdk15ViewGroup$VIEW_ANIMATOR$1.INSTANCE;
    @NotNull
    private static final Function1<Context, _ViewSwitcher> VIEW_SWITCHER = C$$Anko$Factories$Sdk15ViewGroup$VIEW_SWITCHER$1.INSTANCE;
