...
public final class C$$Anko$Factories$Sdk15View {
    @NotNull
    private static final Function1<Context, AdapterViewFlipper> ADAPTER_VIEW_FLIPPER = C$$Anko$Factories$Sdk15View$ADAPTER_VIEW_FLIPPER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, AnalogClock> ANALOG_CLOCK = C$$Anko$Factories$Sdk15View$ANALOG_CLOCK$1.INSTANCE;
    @NotNull
    private static final Function1<Context, AutoCompleteTextView> AUTO_COMPLETE_TEXT_VIEW = C$$Anko$Factories$Sdk15View$AUTO_COMPLETE_TEXT_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, Button> BUTTON = C$$Anko$Factories$Sdk15View$BUTTON$1.INSTANCE;
    @NotNull
    private static final Function1<Context, CalendarView> CALENDAR_VIEW = C$$Anko$Factories$Sdk15View$CALENDAR_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, CheckedTextView> CHECKED_TEXT_VIEW = C$$Anko$Factories$Sdk15View$CHECKED_TEXT_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, CheckBox> CHECK_BOX = C$$Anko$Factories$Sdk15View$CHECK_BOX$1.INSTANCE;
    @NotNull
    private static final Function1<Context, Chronometer> CHRONOMETER = C$$Anko$Factories$Sdk15View$CHRONOMETER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, DatePicker> DATE_PICKER = C$$Anko$Factories$Sdk15View$DATE_PICKER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, DialerFilter> DIALER_FILTER = C$$Anko$Factories$Sdk15View$DIALER_FILTER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, DigitalClock> DIGITAL_CLOCK = C$$Anko$Factories$Sdk15View$DIGITAL_CLOCK$1.INSTANCE;
    @NotNull
    private static final Function1<Context, EditText> EDIT_TEXT = C$$Anko$Factories$Sdk15View$EDIT_TEXT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ExpandableListView> EXPANDABLE_LIST_VIEW = C$$Anko$Factories$Sdk15View$EXPANDABLE_LIST_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ExtractEditText> EXTRACT_EDIT_TEXT = C$$Anko$Factories$Sdk15View$EXTRACT_EDIT_TEXT$1.INSTANCE;
    @NotNull
    private static final Function1<Context, GestureOverlayView> GESTURE_OVERLAY_VIEW = C$$Anko$Factories$Sdk15View$GESTURE_OVERLAY_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, GLSurfaceView> G_L_SURFACE_VIEW = C$$Anko$Factories$Sdk15View$G_L_SURFACE_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ImageButton> IMAGE_BUTTON = C$$Anko$Factories$Sdk15View$IMAGE_BUTTON$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ImageView> IMAGE_VIEW = C$$Anko$Factories$Sdk15View$IMAGE_VIEW$1.INSTANCE;
    public static final C$$Anko$Factories$Sdk15View INSTANCE = new C$$Anko$Factories$Sdk15View();
    @NotNull
    private static final Function1<Context, ListView> LIST_VIEW = C$$Anko$Factories$Sdk15View$LIST_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, MultiAutoCompleteTextView> MULTI_AUTO_COMPLETE_TEXT_VIEW = C$$Anko$Factories$Sdk15View$MULTI_AUTO_COMPLETE_TEXT_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, NumberPicker> NUMBER_PICKER = C$$Anko$Factories$Sdk15View$NUMBER_PICKER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ProgressBar> PROGRESS_BAR = C$$Anko$Factories$Sdk15View$PROGRESS_BAR$1.INSTANCE;
    @NotNull
    private static final Function1<Context, QuickContactBadge> QUICK_CONTACT_BADGE = C$$Anko$Factories$Sdk15View$QUICK_CONTACT_BADGE$1.INSTANCE;
    @NotNull
    private static final Function1<Context, RadioButton> RADIO_BUTTON = C$$Anko$Factories$Sdk15View$RADIO_BUTTON$1.INSTANCE;
    @NotNull
    private static final Function1<Context, RatingBar> RATING_BAR = C$$Anko$Factories$Sdk15View$RATING_BAR$1.INSTANCE;
    @NotNull
    private static final Function1<Context, SearchView> SEARCH_VIEW = C$$Anko$Factories$Sdk15View$SEARCH_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, SeekBar> SEEK_BAR = C$$Anko$Factories$Sdk15View$SEEK_BAR$1.INSTANCE;
    @NotNull
    private static final Function1<Context, SlidingDrawer> SLIDING_DRAWER = C$$Anko$Factories$Sdk15View$SLIDING_DRAWER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, Space> SPACE = C$$Anko$Factories$Sdk15View$SPACE$1.INSTANCE;
    @NotNull
    private static final Function1<Context, Spinner> SPINNER = C$$Anko$Factories$Sdk15View$SPINNER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, StackView> STACK_VIEW = C$$Anko$Factories$Sdk15View$STACK_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, SurfaceView> SURFACE_VIEW = C$$Anko$Factories$Sdk15View$SURFACE_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, Switch> SWITCH = C$$Anko$Factories$Sdk15View$SWITCH$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TabHost> TAB_HOST = C$$Anko$Factories$Sdk15View$TAB_HOST$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TabWidget> TAB_WIDGET = C$$Anko$Factories$Sdk15View$TAB_WIDGET$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TextureView> TEXTURE_VIEW = C$$Anko$Factories$Sdk15View$TEXTURE_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TextView> TEXT_VIEW = C$$Anko$Factories$Sdk15View$TEXT_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TimePicker> TIME_PICKER = C$$Anko$Factories$Sdk15View$TIME_PICKER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ToggleButton> TOGGLE_BUTTON = C$$Anko$Factories$Sdk15View$TOGGLE_BUTTON$1.INSTANCE;
    @NotNull
    private static final Function1<Context, TwoLineListItem> TWO_LINE_LIST_ITEM = C$$Anko$Factories$Sdk15View$TWO_LINE_LIST_ITEM$1.INSTANCE;
    @NotNull
    private static final Function1<Context, VideoView> VIDEO_VIEW = C$$Anko$Factories$Sdk15View$VIDEO_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, View> VIEW = C$$Anko$Factories$Sdk15View$VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ViewFlipper> VIEW_FLIPPER = C$$Anko$Factories$Sdk15View$VIEW_FLIPPER$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ViewStub> VIEW_STUB = C$$Anko$Factories$Sdk15View$VIEW_STUB$1.INSTANCE;
    @NotNull
    private static final Function1<Context, WebView> WEB_VIEW = C$$Anko$Factories$Sdk15View$WEB_VIEW$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ZoomButton> ZOOM_BUTTON = C$$Anko$Factories$Sdk15View$ZOOM_BUTTON$1.INSTANCE;
    @NotNull
    private static final Function1<Context, ZoomControls> ZOOM_CONTROLS = C$$Anko$Factories$Sdk15View$ZOOM_CONTROLS$1.INSTANCE;
