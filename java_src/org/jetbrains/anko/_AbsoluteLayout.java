...
public class _AbsoluteLayout extends AbsoluteLayout {
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, int i3, int i4, @NotNull Function1<? super AbsoluteLayout.LayoutParams, Unit> function1) {
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_AbsoluteLayout _absolutelayout, View view, int i, int i2, int i3, int i4, int i5, Object obj) {
        if (obj == null) {
            if ((i5 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, int i3, int i4) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable Context context, @Nullable AttributeSet attributeSet, @NotNull Function1<? super AbsoluteLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (context == null) {
            Intrinsics.throwNpe();
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams, @NotNull Function1<? super AbsoluteLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
