...
public class _RadioGroup extends RadioGroup {
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable Context context, @Nullable AttributeSet attributeSet, @NotNull Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        ...
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(context, attributeSet);
    ...
    public final <T extends View> T lparams(@NotNull T t, @Nullable Context context, @Nullable AttributeSet attributeSet) {
        ...
        t.setLayoutParams(new RadioGroup.LayoutParams(context, attributeSet));
        return t;
    }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, @NotNull Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    public static /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            view.setLayoutParams(new RadioGroup.LayoutParams(i, i2));
            return view;
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
    }
    ...
    public final <T extends View> T lparams(@NotNull T t, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        t.setLayoutParams(new RadioGroup.LayoutParams(i, i2));
        return t;
    }
    ...
    public static /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, float f, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            Intrinsics.checkParameterIsNotNull(function1, "init");
            RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(i, i2, f);
            function1.invoke(layoutParams);
            view.setLayoutParams(layoutParams);
            return view;
        }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, float f, @NotNull Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(i, i2, f);
        function1.invoke(layoutParams);
    ...
    public static /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, float f, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            view.setLayoutParams(new RadioGroup.LayoutParams(i, i2, f));
            return view;
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: lparams");
    }
    ...
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, float f) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        t.setLayoutParams(new RadioGroup.LayoutParams(i, i2, f));
        return t;
    }

    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams, @NotNull Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
        }
        RadioGroup.LayoutParams layoutParams2 = new RadioGroup.LayoutParams(layoutParams);
    ...
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams) {
        ...
        t.setLayoutParams(new RadioGroup.LayoutParams(layoutParams));
        return t;
    }

    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.MarginLayoutParams marginLayoutParams, @NotNull Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.MarginLayoutParams marginLayoutParams) {
        ...
        t.setLayoutParams(new RadioGroup.LayoutParams(marginLayoutParams));
        return t;
    }
}
