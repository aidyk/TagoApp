...
public class _AlertDialogLayout extends AlertDialogLayout {
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_AlertDialogLayout _alertdialoglayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, @NotNull Function1<? super LinearLayoutCompat.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        LinearLayoutCompat.LayoutParams layoutParams = new LinearLayoutCompat.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_AlertDialogLayout _alertdialoglayout, View view, int i, int i2, float f, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, float f, @NotNull Function1<? super LinearLayoutCompat.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        LinearLayoutCompat.LayoutParams layoutParams = new LinearLayoutCompat.LayoutParams(i, i2, f);
        function1.invoke(layoutParams);
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_AlertDialogLayout _alertdialoglayout, View view, int i, int i2, float f, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams, @NotNull Function1<? super LinearLayoutCompat.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.MarginLayoutParams marginLayoutParams, @NotNull Function1<? super LinearLayoutCompat.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable LinearLayoutCompat.LayoutParams layoutParams, @NotNull Function1<? super LinearLayoutCompat.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable LinearLayoutCompat.LayoutParams layoutParams) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
        }
