...
public class _ActionBarOverlayLayout extends ActionBarOverlayLayout {
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable Context context, @Nullable AttributeSet attributeSet, @NotNull Function1<? super ActionBarOverlayLayout.LayoutParams, Unit> function1) {
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_ActionBarOverlayLayout _actionbaroverlaylayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, @NotNull Function1<? super ActionBarOverlayLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        ActionBarOverlayLayout.LayoutParams layoutParams = new ActionBarOverlayLayout.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    @NotNull
    public static /* synthetic */ View lparams$default(_ActionBarOverlayLayout _actionbaroverlaylayout, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams, @NotNull Function1<? super ActionBarOverlayLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.MarginLayoutParams marginLayoutParams, @NotNull Function1<? super ActionBarOverlayLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
