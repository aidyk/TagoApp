...
public class _ActionMenuView extends ActionMenuView {
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable Context context, @Nullable AttributeSet attributeSet, @NotNull Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ViewGroup.LayoutParams layoutParams, @NotNull Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ActionMenuView.LayoutParams layoutParams, @NotNull Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, @Nullable ActionMenuView.LayoutParams layoutParams) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
        }
    ...
    @NotNull
    public final <T extends View> T lparams(@NotNull T t, int i, int i2, @NotNull Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "receiver$0");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        ActionMenuView.LayoutParams layoutParams = new ActionMenuView.LayoutParams(i, i2);
        function1.invoke(layoutParams);
