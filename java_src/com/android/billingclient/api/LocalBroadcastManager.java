...
class LocalBroadcastManager {
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new Handler(context.getMainLooper()) {
            /* class com.android.billingclient.api.LocalBroadcastManager.AnonymousClass1 */
    ...
    private void executePendingBroadcasts() {
        ...
        L_0x0000:
            ...
            monitor-enter(r0)
            java.util.ArrayList<com.android.billingclient.api.LocalBroadcastManager$BroadcastRecord> r1 = r8.mPendingBroadcasts     // Catch:{ all -> 0x0041 }
            int r1 = r1.size()     // Catch:{ all -> 0x0041 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0041 }
            return
        L_0x000d:
            com.android.billingclient.api.LocalBroadcastManager$BroadcastRecord[] r1 = new com.android.billingclient.api.LocalBroadcastManager.BroadcastRecord[r1]     // Catch:{ all -> 0x0041 }
            java.util.ArrayList<com.android.billingclient.api.LocalBroadcastManager$BroadcastRecord> r2 = r8.mPendingBroadcasts     // Catch:{ all -> 0x0041 }
