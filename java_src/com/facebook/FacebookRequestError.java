            ...
            if (jSONObject.has("code")) {
                ...
                if (stringPropertyAsJSON != null && (stringPropertyAsJSON instanceof JSONObject)) {
                    ...
                    if (jSONObject2.has("error")) {
                        ...
                        if (!jSONObject2.has("error_code") && !jSONObject2.has(ERROR_MSG_KEY)) {
                    ...
                    if (z2) {
                        return new FacebookRequestError(i2, i3, i, str4, str3, str, str2, z, jSONObject2, jSONObject, obj, httpURLConnection, null);
                    }
                }
