    ...
    private final zzm zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                zzm = (!zza.zzad || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || (honorsDebugCertificates && !zzc.zza(str2, zzf, false, false).zzad)) ? zza : zzm.zzb("debuggable release cert app rejected");
            }
            if (zzm.zzad) {
                this.zzan = str;
            }
