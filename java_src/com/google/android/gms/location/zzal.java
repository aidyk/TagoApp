...
public final class zzal extends AbstractSafeParcelable {
    ...
    zzal(@SafeParcelable.Param(id = 1) @Nullable List<String> list, @SafeParcelable.Param(id = 2) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(id = 3) String str) {
