...
final class zzed extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        if (!this.zzbeh || this.zzbei + DateUtils.MILLIS_PER_HOUR <= this.zzbeg.zzrz.currentTimeMillis()) {
            SQLiteDatabase sQLiteDatabase = null;
            this.zzbeh = true;
            this.zzbei = this.zzbeg.zzrz.currentTimeMillis();
            try {
                sQLiteDatabase = super.getWritableDatabase();
            } catch (SQLiteException unused) {
                this.zzbeg.zzri.getDatabasePath(this.zzbeg.zzbed).delete();
            }
