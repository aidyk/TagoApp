        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (zzyv.zzd(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzyv.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzwe.zzxe();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzyv.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzwe.zzxe();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> '\f') | DimensionsKt.XXHDPI);
                int i11 = i10 + 1;
