...
interface zzzh {
    ...
    void zza(int i, zzun zzun) throws IOException;

    <K, V> void zza(int i, zzwx<K, V> zzwx, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxu zzxu) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxu zzxu) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxu zzxu) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzun> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzxu zzxu) throws IOException;
    ...
    @Deprecated
    void zzbl(int i) throws IOException;

    @Deprecated
    void zzbm(int i) throws IOException;
