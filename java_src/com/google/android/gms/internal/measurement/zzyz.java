...
final class zzyz extends zzyw {
    ...
    /* access modifiers changed from: package-private */
    @Override // com.google.android.gms.internal.measurement.zzyw
    public final String zzh(byte[] bArr, int i, int i2) throws zzwe {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            int i3 = i + i2;
            char[] cArr = new char[i2];
            int i4 = 0;
            while (i < i3) {
                byte zza = zzys.zza(bArr, (long) i);
                if (!(zzyv.zzd(zza))) {
                    break;
                }
                i++;
                zzyv.zza(zza, cArr, i4);
                i4++;
            }
            int i5 = i4;
            while (i < i3) {
                int i6 = i + 1;
                byte zza2 = zzys.zza(bArr, (long) i);
                if (zzyv.zzd(zza2)) {
                    int i7 = i5 + 1;
                    zzyv.zza(zza2, cArr, i5);
                    while (i6 < i3) {
                        byte zza3 = zzys.zza(bArr, (long) i6);
                        if (!(zzyv.zzd(zza3))) {
                            break;
                        }
                        i6++;
                        zzyv.zza(zza3, cArr, i7);
                        i7++;
                    }
                    i = i6;
                    i5 = i7;
                } else if (zzyv.zze(zza2)) {
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        zzyv.zza(zza2, zzys.zza(bArr, (long) i6), cArr, i5);
                        i = i8;
                        i5++;
                    } else {
                        throw zzwe.zzxe();
                    }
                } else if (zzyv.zzf(zza2)) {
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzyv.zza(zza2, zzys.zza(bArr, (long) i6), zzys.zza(bArr, (long) i9), cArr, i5);
                        i = i10;
                        i5++;
                    } else {
                        throw zzwe.zzxe();
                    ...
                    int i11 = i6 + 1;
                    int i12 = i11 + 1;
                    zzyv.zza(zza2, zzys.zza(bArr, (long) i6), zzys.zza(bArr, (long) i11), zzys.zza(bArr, (long) i12), cArr, i5);
                    i = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzwe.zzxe();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i4 < length) {
            ...
            if (charAt3 < 128 && j2 < j3) {
                j = j2 + 1;
                zzys.zza(bArr, j2, (byte) charAt3);
            } else if (charAt3 < 2048 && j2 <= j3 - 2) {
                long j4 = j2 + 1;
                zzys.zza(bArr, j2, (byte) ((charAt3 >>> 6) | 960));
                j2 = j4 + 1;
                zzys.zza(bArr, j4, (byte) ((charAt3 & '?') | 128));
                i4++;
            } else if ((charAt3 < 55296 || 57343 < charAt3) && j2 <= j3 - 3) {
                long j5 = j2 + 1;
                zzys.zza(bArr, j2, (byte) ((charAt3 >>> '\f') | DimensionsKt.XXHDPI));
                long j6 = j5 + 1;
                zzys.zza(bArr, j5, (byte) (((charAt3 >>> 6) & 63) | 128));
                j = j6 + 1;
                zzys.zza(bArr, j6, (byte) ((charAt3 & '?') | 128));
            } else if (j2 <= j3 - 4) {
                int i5 = i4 + 1;
                if (i5 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j8 = j7 + 1;
                        zzys.zza(bArr, j7, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j9 = j8 + 1;
                        zzys.zza(bArr, j8, (byte) (((codePoint >>> 6) & 63) | 128));
                        j2 = j9 + 1;
                        zzys.zza(bArr, j9, (byte) ((codePoint & 63) | 128));
                        i4 = i5;
                        i4++;
                    }
                } else {
    ...
    public final void zzb(java.lang.CharSequence r21, java.nio.ByteBuffer r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzyz.zzb(java.lang.CharSequence, java.nio.ByteBuffer):void");
    }
