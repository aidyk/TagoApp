...
public final /* synthetic */ class zzfq {
    static final /* synthetic */ int[] zzrr = new int[zzjd.values().length];
    static final /* synthetic */ int[] zztq = new int[zzji.values().length];
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.vision.zzfq.<clinit>():void");
    }
}
