...
final class zzhy {
    ...
    static int zzq(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzh(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzr(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzi(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzs(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzj(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzt(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzbb(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzu(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzaw(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzv(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzax(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzfe.zzay(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    private static zzio<?, ?> zzk(boolean z) {
        try {
            ...
            return (zzio) zzgt.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z));
    ...
    static <T> void zza(zzha zzha, T t, T t2, long j) {
        zziu.zza(t, j, zzha.zzb(zziu.zzp(t, j), zziu.zzp(t2, j)));
    }
    ...
    static <UT, UB> UB zza(int i, List<Integer> list, zzgc<?> zzgc, UB ub, zzio<UT, UB> zzio) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (zzgc.zzf(intValue) != null) {
                ...
                ub2 = (UB) zza(i, intValue, ub2, zzio);
            }
        }
        if (i2 != size) {
        ...
        if (!(list instanceof RandomAccess)) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (zzgd.zzh(intValue2)) {
                    ...
                    ub2 = (UB) zza(i, intValue2, ub2, zzio);
                }
            }
            if (i2 != size) {
                list.subList(i2, size).clear();
