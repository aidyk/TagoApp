...
public abstract class zzfe extends zzen {
    ...
    public static final class zzd extends zzfe {
        ...
        public final void zzas(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzsw.put((byte) ((i & WorkQueueKt.MASK) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zze(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzsw.put((byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzas(int i) throws IOException {
            if (this.zztb <= this.zzta) {
                while ((i & -128) != 0) {
                    long j = this.zztb;
                    this.zztb = j + 1;
                    zziu.zza(j, (byte) ((i & WorkQueueKt.MASK) | 128));
                    i >>>= 7;
                }
                long j2 = this.zztb;
                this.zztb = 1 + j2;
            ...
            while (this.zztb < this.zzsz) {
                ...
                long j4 = this.zztb;
                this.zztb = j4 + 1;
                zziu.zza(j4, (byte) ((i & WorkQueueKt.MASK) | 128));
                i >>>= 7;
            }
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.zztb), Long.valueOf(this.zzsz), 1));
        }
        ...
        public final void zze(long j) throws IOException {
            if (this.zztb <= this.zzta) {
                while ((j & -128) != 0) {
                    long j2 = this.zztb;
                    this.zztb = j2 + 1;
                    zziu.zza(j2, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    j >>>= 7;
                }
                long j3 = this.zztb;
                this.zztb = 1 + j3;
            ...
            while (this.zztb < this.zzsz) {
                ...
                long j5 = this.zztb;
                this.zztb = j5 + 1;
                zziu.zza(j5, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                j >>>= 7;
            }
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.zztb), Long.valueOf(this.zzsz), 1));
        }
        ...
        public final void zzas(int i) throws IOException {
            if (!zzfe.zzsr || zzdz() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zziu.zza(bArr3, (long) i4, (byte) ((i & WorkQueueKt.MASK) | 128));
                    i >>>= 7;
                }
        ...
        public final void zze(long j) throws IOException {
            if (!zzfe.zzsr || zzdz() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zziu.zza(bArr3, (long) i3, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
