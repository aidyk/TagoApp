...
public interface zzjj {
    ...
    void zza(int i, zzeo zzeo) throws IOException;

    <K, V> void zza(int i, zzgy<K, V> zzgy, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhw zzhw) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhw zzhw) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhw zzhw) throws IOException;

    void zzb(int i, List<zzeo> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhw zzhw) throws IOException;
    ...
    @Deprecated
    void zzbe(int i) throws IOException;

    @Deprecated
    void zzbf(int i) throws IOException;
