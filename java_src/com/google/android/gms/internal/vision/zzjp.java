...
public final class zzjp implements Cloneable {
    ...
    public final zzjq zzbw(int i) {
        int zzby = zzby(i);
        if (zzby < 0 || this.zzadl[zzby] == zzadi) {
            return null;
        }
        return this.zzadl[zzby];
    }
    ...
    public final void zza(int i, zzjq zzjq) {
        ...
        int i2 = zzby ^ -1;
        if (i2 >= this.mSize || this.zzadl[i2] != zzadi) {
            ...
            if (this.mSize - i2 != 0) {
                int i3 = i2 + 1;
                System.arraycopy(this.zzadk, i2, this.zzadk, i3, this.mSize - i2);
                System.arraycopy(this.zzadl, i2, this.zzadl, i3, this.mSize - i2);
            }
            this.zzadk[i2] = i;
            this.zzadl[i2] = zzjq;
            this.mSize++;
