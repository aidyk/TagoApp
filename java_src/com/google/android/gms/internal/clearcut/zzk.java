    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            if (length > 16) {
                ...
                return zza(Long.rotateRight(zzb + zzb2, 43) + Long.rotateRight(zzb3, 30) + (zzb(bArr, i2 - 16) * -7286425919675154353L), zzb + Long.rotateRight(zzb2 - 7286425919675154353L, 18) + zzb3, j2);
            } else if (length >= 8) {
                ...
                return zza(((((long) zza(bArr, 0)) & 4294967295L) << 3) + ((long) length), ((long) zza(bArr, (length + 0) - 4)) & 4294967295L, ((long) (length << 1)) - 7286425919675154353L);
            } else if (length <= 0) {
                return -7286425919675154353L;
            } else {
                long j4 = (((long) ((bArr[0] & UByte.MAX_VALUE) + ((bArr[(length >> 1) + 0] & UByte.MAX_VALUE) << 8))) * -7286425919675154353L) ^ (((long) (length + ((bArr[(length - 1) + 0] & UByte.MAX_VALUE) << 2))) * -4348849565147123417L);
            ...
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr, i3 - 24)) * j5), zzb9 + Long.rotateRight(zzb10 + zzb6, 18) + zzb11, j5);
        } else {
            ...
            while (true) {
                ...
                long rotateRight3 = (Long.rotateRight(j6 + jArr[1] + zzb(bArr, i8 + 48), 42) * j) + jArr[0] + zzb(bArr, i8 + 40);
                long rotateRight4 = Long.rotateRight(j7 + jArr2[0], 33) * j;
                zza(bArr, i8, jArr[1] * j, jArr2[0] + rotateRight2, jArr);
                ...
                if (i9 == i5) {
                    ...
                    long rotateRight5 = (Long.rotateRight(((rotateRight4 + rotateRight3) + jArr[0]) + zzb(bArr, i7 + 8), 37) * j8) ^ (jArr2[1] * 9);
                    long rotateRight6 = (Long.rotateRight(rotateRight3 + jArr[1] + zzb(bArr, i7 + 48), 42) * j8) + (jArr[0] * 9) + zzb(bArr, i7 + 40);
                    ...
                    return zza(zza(jArr[0], jArr2[0], j8) + ((rotateRight6 ^ (rotateRight6 >>> 47)) * -4348849565147123417L) + rotateRight5, zza(jArr[1], jArr2[1], j8) + rotateRight7, j8);
                }
                i8 = i9;
                i6 = i6;
                i5 = i5;
