        ...
        public final void zzb(long j) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfd.zza(bArr3, (long) i3, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    zzfd.zza(bArr3, (long) i4, (byte) ((i & WorkQueueKt.MASK) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i5 = this.position;
            ...
            if (this.zzgi <= this.zzgh) {
                ...
                while (this.zzgi < this.zzgg) {
                    if ((j & -128) != 0) {
                        long j3 = this.zzgi;
                        this.zzgi = j3 + 1;
                        zzfd.zza(j3, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                        j >>>= 7;
                    }
                }
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.zzgi), Long.valueOf(this.zzgg), 1));
            ...
            if (this.zzgi <= this.zzgh) {
                ...
                while (this.zzgi < this.zzgg) {
                    if ((i & -128) != 0) {
                        long j2 = this.zzgi;
                        this.zzgi = j2 + 1;
                        zzfd.zza(j2, (byte) ((i & WorkQueueKt.MASK) | 128));
                        i >>>= 7;
                    }
                }
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.zzgi), Long.valueOf(this.zzgg), 1));
