...
public interface zzfr {
    ...
    void zza(int i, zzbb zzbb) throws IOException;

    <K, V> void zza(int i, zzdh<K, V> zzdh, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzef zzef) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzef zzef) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzef zzef) throws IOException;

    void zzb(int i, List<zzbb> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzef zzef) throws IOException;
