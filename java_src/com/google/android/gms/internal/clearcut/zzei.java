...
public class zzei<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.clearcut.zzei<K extends java.lang.Comparable<K>, V> */
    ...
    public final V put(K k, V v) {
        ...
        if (this.zzom.size() == this.zzol) {
            zzep remove = this.zzom.remove(this.zzol - 1);
