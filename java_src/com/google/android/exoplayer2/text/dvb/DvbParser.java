...
public final class DvbParser {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            if (i < 8) {
                ...
                if (i5 == 0) {
                    ...
                    iArr[i] = getColor(WorkQueueKt.MASK, i16, i17, i7 + i6);
                }
            }
        }
        return iArr;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x007e A[LOOP:0: B:1:0x0009->B:27:0x007e, LOOP_END] */
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:24:0x006d */
    /* JADX DEBUG: Multi-variable search result rejected for r15v0, resolved type: byte[] */
    /* JADX DEBUG: Multi-variable search result rejected for r3v4, resolved type: byte */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r3v2 */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x006f  */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0089 A[LOOP:0: B:1:0x0009->B:30:0x0089, LOOP_END] */
