...
public final class ParsableNalUnitBitArray {
    ...
    public int readBits(int i) {
        ...
        while (true) {
            ...
            this.bitOffset -= 8;
            i3 |= (this.data[this.byteOffset] & UByte.MAX_VALUE) << this.bitOffset;
        ...
        int i5 = (-1 >>> (32 - i)) & (i3 | ((this.data[this.byteOffset] & UByte.MAX_VALUE) >> (8 - this.bitOffset)));
        if (this.bitOffset == 8) {
            this.bitOffset = 0;
