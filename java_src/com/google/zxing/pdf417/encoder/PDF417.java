...
public final class PDF417 {
    ...
    private void encodeLowLevel(CharSequence charSequence, int i, int i2, int i3, BarcodeMatrix barcodeMatrix2) {
        ...
        while (i6 < i2) {
            ...
            encodeChar(CODEWORD_TABLE[i8][i4], 17, barcodeMatrix2.getCurrentRow());
            int i13 = i7;
            for (int i14 = 0; i14 < i; i14++) {
                encodeChar(CODEWORD_TABLE[i8][charSequence.charAt(i13)], 17, barcodeMatrix2.getCurrentRow());
                i13++;
            }
            if (this.compact) {
                encodeChar(STOP_PATTERN, 1, barcodeMatrix2.getCurrentRow());
            } else {
                encodeChar(CODEWORD_TABLE[i8][i5], 17, barcodeMatrix2.getCurrentRow());
    ...
    private int[] determineDimensions(int i, int i2) throws WriterException {
        ...
        float f = 0.0f;
        int[] iArr = null;
        while (i3 <= this.maxCols && (calculateNumberOfRows = calculateNumberOfRows(i, i2, i3)) >= this.minRows) {
            if (calculateNumberOfRows <= this.maxRows) {
                float f2 = (((float) ((i3 * 17) + 69)) * DEFAULT_MODULE_WIDTH) / (((float) calculateNumberOfRows) * HEIGHT);
        ...
        if (iArr == null && calculateNumberOfRows(i, i2, this.minCols) < this.minRows) {
            iArr = new int[]{this.minCols, this.minRows};
        }
        if (iArr != null) {
            return iArr;
        }
