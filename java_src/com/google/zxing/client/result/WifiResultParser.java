...
public final class WifiResultParser extends ResultParser {
    ...
    public WifiParsedResult parse(Result result) {
        ...
        if (!massagedText.startsWith(Wifi.WIFI_PROTOCOL_HEADER) || (matchSinglePrefixedField = matchSinglePrefixedField("S:", massagedText, ';', false)) == null || matchSinglePrefixedField.isEmpty()) {
            return null;
        }
