...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            resultPoint3 = correctTopRightRectangular(resultPoint13, resultPoint12, resultPoint14, resultPoint, i, i2);
            ...
            bitMatrix = sampleGrid(this.image, resultPoint2, resultPoint13, resultPoint12, resultPoint3, transitions3, transitions4);
        } else {
            ...
            bitMatrix = sampleGrid(this.image, resultPoint14, resultPoint13, resultPoint12, resultPoint3, max, max);
            resultPoint2 = resultPoint14;
        }
