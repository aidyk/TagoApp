...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, SubsamplingScaleImageView.ORIENTATION_180, 118, 143, 7, 21, 63}, new int[]{PsExtractor.PRIVATE_STREAM_1, 145, 13, 39, 117, 140, 209, JpegHeader.TAG_M_SOF13}, new int[]{JpegHeader.TAG_M_SOF1, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, JpegHeader.TAG_M_SOF5, 169, 85, 44, 132}, new int[]{185, 133, 188, 142, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, TsExtractor.TS_STREAM_TYPE_DTS, JpegHeader.TAG_M_SOF11, 187, 139, JpegHeader.TAG_M_SOF14, JpegHeader.TAG_M_DHT, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, 155}, new int[]{43, TsExtractor.TS_STREAM_TYPE_AC3, 176, 106, 107, 110, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, 178, 112, 125, 164}, new int[]{70, 210, 208, JpegHeader.TAG_M_SOF10, 184, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, 179, 115}, new int[]{TsExtractor.TS_STREAM_TYPE_SPLICE_INFO, 191, 151, 31, 93, 68, 204, FacebookRequestErrorClassification.EC_INVALID_TOKEN}, new int[]{148, 22, 66, JpegHeader.TAG_M_SOF6, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, JpegHeader.TAG_M_SOF15, JpegHeader.TAG_M_SOF7, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, 183, WorkQueueKt.MASK, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, TsExtractor.TS_STREAM_TYPE_E_AC3, JpegHeader.TAG_M_SOF2, DimensionsKt.MDPI, 58, 174, 100, 89}};
    ...
    private FinderPattern parseFoundFinderPattern(BitArray bitArray, int i, boolean z) {
        ...
        try {
            return new FinderPattern(parseFinderValue(decodeFinderCounters, FINDER_PATTERNS), new int[]{i2, i4}, i2, i4, i);
        } catch (NotFoundException unused) {
            return null;
        }
    }
