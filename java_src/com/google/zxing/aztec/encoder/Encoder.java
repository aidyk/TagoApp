    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            while (i11 <= 32) {
                ...
                if (size2 <= i14) {
                    if (i12 != WORD_SIZE[i13]) {
                        i12 = WORD_SIZE[i13];
                        bitArray2 = stuffBits(encode, i12);
                    }
                    int i15 = i14 - (i14 % i12);
            ...
            while (i26 < i25) {
                ...
                while (i9 < i17) {
                    ...
                    if (generateCheckWords.get((i25 << 1) + i24 + i27 + i9)) {
                        int i29 = i23 << 1;
                        bitMatrix.set(iArr[i29 + i26], iArr[((i16 - 1) - i29) - i9]);
                    }
                    ...
                    if (generateCheckWords.get((i25 * 6) + i24 + i27 + i9)) {
                        int i31 = i23 << 1;
                        bitMatrix.set(iArr[((i16 - 1) - i31) - i26], iArr[i31 + i9]);
                    }
                    i9++;
                    i17 = 2;
                }
