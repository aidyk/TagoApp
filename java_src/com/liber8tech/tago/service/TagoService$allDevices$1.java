...
public final class TagoService$allDevices$1<T> implements Predicate<Pair<? extends Boolean, ? extends Boolean>> {
    public static final TagoService$allDevices$1 INSTANCE = new TagoService$allDevices$1();

    TagoService$allDevices$1() {
    }
