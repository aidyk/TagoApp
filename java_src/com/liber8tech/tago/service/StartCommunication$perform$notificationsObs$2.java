...
public final class StartCommunication$perform$notificationsObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    public static final StartCommunication$perform$notificationsObs$2 INSTANCE = new StartCommunication$perform$notificationsObs$2();

    StartCommunication$perform$notificationsObs$2() {
    }
