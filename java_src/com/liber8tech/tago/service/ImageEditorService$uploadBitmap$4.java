...
public final class ImageEditorService$uploadBitmap$4<T, R> implements Function<T, R> {
    final /* synthetic */ ImageEditorService this$0;

    ImageEditorService$uploadBitmap$4(ImageEditorService imageEditorService) {
    ...
    public final void apply(@NotNull ResponseBody responseBody) {
        ...
        BufferedSink buffer = Okio.buffer(Okio.sink(new File(file.getPath() + IOUtils.DIR_SEPARATOR_UNIX + UUID.randomUUID() + ".jpg")));
