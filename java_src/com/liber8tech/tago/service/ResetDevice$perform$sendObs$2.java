...
public final class ResetDevice$perform$sendObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    final /* synthetic */ ResetDevice this$0;

    ResetDevice$perform$sendObs$2(ResetDevice resetDevice) {
