...
public final class ResetDevice$perform$notificationsObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    public static final ResetDevice$perform$notificationsObs$2 INSTANCE = new ResetDevice$perform$notificationsObs$2();

    ResetDevice$perform$notificationsObs$2() {
    }
