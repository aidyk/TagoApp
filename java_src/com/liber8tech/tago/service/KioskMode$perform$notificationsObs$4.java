...
public final class KioskMode$perform$notificationsObs$4<T, R> implements Function<T, R> {
    public static final KioskMode$perform$notificationsObs$4 INSTANCE = new KioskMode$perform$notificationsObs$4();

    KioskMode$perform$notificationsObs$4() {
    }
