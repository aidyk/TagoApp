...
public final class StartCommunication$processMessage$1<T> implements Consumer<Message> {
    final /* synthetic */ StartCommunication this$0;

    StartCommunication$processMessage$1(StartCommunication startCommunication) {
