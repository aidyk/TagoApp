...
public final class ImageEditorService$uploadBitmap$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    final /* synthetic */ ImageEditorService this$0;

    ImageEditorService$uploadBitmap$2(ImageEditorService imageEditorService) {
