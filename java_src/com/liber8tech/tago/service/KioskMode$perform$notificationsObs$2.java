...
public final class KioskMode$perform$notificationsObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    public static final KioskMode$perform$notificationsObs$2 INSTANCE = new KioskMode$perform$notificationsObs$2();

    KioskMode$perform$notificationsObs$2() {
    }
