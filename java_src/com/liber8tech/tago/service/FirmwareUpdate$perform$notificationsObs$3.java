...
public final class FirmwareUpdate$perform$notificationsObs$3<T> implements Consumer<Message> {
    final /* synthetic */ FirmwareUpdate this$0;

    FirmwareUpdate$perform$notificationsObs$3(FirmwareUpdate firmwareUpdate) {
    ...
    public final void accept(Message message) {
        ...
        firmwareUpdate.processMessage(message);
    }
}
