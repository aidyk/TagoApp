...
public final class PatternSync$perform$notificationsObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    public static final PatternSync$perform$notificationsObs$2 INSTANCE = new PatternSync$perform$notificationsObs$2();

    PatternSync$perform$notificationsObs$2() {
    }
