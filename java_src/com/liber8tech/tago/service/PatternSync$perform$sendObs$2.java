...
public final class PatternSync$perform$sendObs$2<T, R> implements Function<T, ObservableSource<? extends R>> {
    final /* synthetic */ PatternSync this$0;

    PatternSync$perform$sendObs$2(PatternSync patternSync) {
    ...
    public final Observable<byte[]> apply(@NotNull Message message) {
        ...
        return message.command() == Command.DATA_PART_SEND ? (Observable<R>) message.chunks(20).flatMap(new Function<T, ObservableSource<? extends R>>(this) {
            /* class com.liber8tech.tago.service.PatternSync$perform$sendObs$2.AnonymousClass1 */
            final /* synthetic */ PatternSync$perform$sendObs$2 this$0;
