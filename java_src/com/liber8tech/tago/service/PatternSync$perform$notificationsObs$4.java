...
public final class PatternSync$perform$notificationsObs$4<T, R> implements Function<T, R> {
    public static final PatternSync$perform$notificationsObs$4 INSTANCE = new PatternSync$perform$notificationsObs$4();

    PatternSync$perform$notificationsObs$4() {
    }
