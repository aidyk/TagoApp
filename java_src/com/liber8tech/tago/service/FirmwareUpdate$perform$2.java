...
public final class FirmwareUpdate$perform$2<T> implements Predicate<SyncState> {
    public static final FirmwareUpdate$perform$2 INSTANCE = new FirmwareUpdate$perform$2();

    FirmwareUpdate$perform$2() {
    }
