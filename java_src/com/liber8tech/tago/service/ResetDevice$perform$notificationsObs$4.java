...
public final class ResetDevice$perform$notificationsObs$4<T, R> implements Function<T, R> {
    public static final ResetDevice$perform$notificationsObs$4 INSTANCE = new ResetDevice$perform$notificationsObs$4();

    ResetDevice$perform$notificationsObs$4() {
    }
