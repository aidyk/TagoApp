...
public final class FirmwareUpdate$perform$chunksObs$1<T1, T2, R> implements BiFunction<Unit, Message, Unit> {
    final /* synthetic */ Ref.IntRef $chunkIndex;
    final /* synthetic */ double $steps;
    final /* synthetic */ FirmwareUpdate this$0;

    FirmwareUpdate$perform$chunksObs$1(FirmwareUpdate firmwareUpdate, Ref.IntRef intRef, double d) {
    ...
    public final void apply(@NotNull Unit unit, @NotNull Message message) {
        ...
        FirmwareUpdate firmwareUpdate = this.this$0;
        Ref.IntRef intRef = this.$chunkIndex;
        intRef.element++;
        double d = (double) intRef.element;
        double d2 = this.$steps;
        Double.isNaN(d);
        FirmwareUpdate.updateProgress$default(firmwareUpdate, Double.valueOf(d / d2), null, 2, null);
    }
}
