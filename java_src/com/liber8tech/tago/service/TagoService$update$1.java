...
public final class TagoService$update$1<T, R> implements Function<T, ObservableSource<? extends R>> {
    public static final TagoService$update$1 INSTANCE = new TagoService$update$1();

    TagoService$update$1() {
    }

    @NotNull
    public final Observable<Unit> apply(@NotNull TagoDevice tagoDevice) {
        Intrinsics.checkParameterIsNotNull(tagoDevice, "it");
        return RxRealm.INSTANCE.save(tagoDevice);
    }
}
