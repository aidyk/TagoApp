...
public final class Firmware$chunks$array$1<T, R> implements Function<T, R> {
    public static final Firmware$chunks$array$1 INSTANCE = new Firmware$chunks$array$1();

    Firmware$chunks$array$1() {
    }
