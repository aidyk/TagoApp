...
public final class ContextExtensionKt$showToUDialog$1 extends Lambda implements Function1<AlertBuilder<? extends DialogInterface>, Unit> {
    public static final ContextExtensionKt$showToUDialog$1 INSTANCE = new ContextExtensionKt$showToUDialog$1();

    ContextExtensionKt$showToUDialog$1() {
        super(1);
    }
