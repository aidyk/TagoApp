...
public final class RxRealm$saveReturnResult$$inlined$transactionWithResult$1<T, R> implements Function<T, ObservableSource<? extends R>> {
    final /* synthetic */ RealmObject $data$inlined;

    public RxRealm$saveReturnResult$$inlined$transactionWithResult$1(RealmObject realmObject) {
    ...
    public final Observable<T> apply(@NotNull final Realm realm) {
        ...
        return Observable.create(new ObservableOnSubscribe<T>(this) {
            /* class com.liber8tech.tago.util.RxRealm$saveReturnResult$$inlined$transactionWithResult$1.AnonymousClass1 */
            final /* synthetic */ RxRealm$saveReturnResult$$inlined$transactionWithResult$1 this$0;
            ...
            public final void subscribe(@NotNull final ObservableEmitter<T> observableEmitter) {
                ...
                realm.executeTransactionAsync(new Realm.Transaction(this) {
                    /* class com.liber8tech.tago.util.RxRealm$saveReturnResult$$inlined$transactionWithResult$1.AnonymousClass1.AnonymousClass1 */
                    ...
                    public final void execute(Realm realm) {
                        ...
                        objectRef.element = (T) ((RealmObject) realm.copyToRealm(this.this$0.this$0.$data$inlined));
                        objectRef.element = (T) ((RealmObject) realm.copyFromRealm((RealmModel) objectRef.element));
                    }
                }, new Realm.Transaction.OnSuccess(this) {
                    /* class com.liber8tech.tago.util.RxRealm$saveReturnResult$$inlined$transactionWithResult$1.AnonymousClass1.AnonymousClass2 */
                    final /* synthetic */ AnonymousClass1 this$0;
                    ...
                    /* class com.liber8tech.tago.util.RxRealm$saveReturnResult$$inlined$transactionWithResult$1.AnonymousClass1.AnonymousClass3 */
                    final /* synthetic */ AnonymousClass1 this$0;
