...
final class PackActivity$getToolbarLeftIconClick$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ PackActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PackActivity$getToolbarLeftIconClick$1(PackActivity packActivity) {
        super(1);
