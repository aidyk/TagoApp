...
final class KioskActivity$observeServices$2<T> implements Consumer<Pair<? extends Boolean, ? extends Boolean>> {
    final /* synthetic */ Snackbar $snackbar;
    final /* synthetic */ KioskActivity this$0;

    KioskActivity$observeServices$2(KioskActivity kioskActivity, Snackbar snackbar) {
    ...
    public final void accept(Pair<Boolean, Boolean> pair) {
        if (!pair.getFirst().booleanValue() || !pair.getSecond().booleanValue()) {
            KioskActivity.access$getUi$p(this.this$0).setDim(true);
            this.$snackbar.setText(!pair.getFirst().booleanValue() ? R.string.location_turned_off : R.string.bt_turned_off);
            this.$snackbar.show();
            return;
        }
        KioskActivity.access$getUi$p(this.this$0).setDim(false);
