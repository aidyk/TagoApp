...
final class ChangePasswordActivity$clickSave$3<T> implements Consumer<Throwable> {
    final /* synthetic */ ChangePasswordActivity this$0;

    ChangePasswordActivity$clickSave$3(ChangePasswordActivity changePasswordActivity) {
        this.this$0 = changePasswordActivity;
    }

    public final void accept(Throwable th) {
        AnalyticsApi.DefaultImpls.trackEvent$default(this.this$0.getAnalytics(), "Change Password", Category.auth, "Change Password", th.getMessage(), null, null, null, null, null, 496, null);
