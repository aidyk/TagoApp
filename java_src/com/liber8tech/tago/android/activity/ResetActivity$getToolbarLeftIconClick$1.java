...
final class ResetActivity$getToolbarLeftIconClick$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ ResetActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ResetActivity$getToolbarLeftIconClick$1(ResetActivity resetActivity) {
        super(1);
