...
final class TagoAdapter$onCreateViewHolder$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ TagoHolder $holder;
    final /* synthetic */ TagoAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TagoAdapter$onCreateViewHolder$1(TagoAdapter tagoAdapter, TagoHolder tagoHolder) {
        super(1);
        this.this$0 = tagoAdapter;
    ...
    public final void invoke(@Nullable View view) {
        Function1 access$getOnDeviceClick$p = TagoAdapter.access$getOnDeviceClick$p(this.this$0);
