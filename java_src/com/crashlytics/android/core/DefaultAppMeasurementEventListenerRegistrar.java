...
public class DefaultAppMeasurementEventListenerRegistrar implements AppMeasurementEventListenerRegistrar {
    ...
    private Object getInstance(Class<?> cls) {
        try {
            ...
            Fabric.getLogger().d(CrashlyticsCore.TAG, "Could not get instance of com.google.android.gms.measurement.AppMeasurement", e);
            return null;
        }
    }
    ...
    private boolean invoke(Class<?> cls, Object obj, String str) {
        ...
        try {
            ...
            logger.w(CrashlyticsCore.TAG, "Expected method missing: " + str, e);
            return false;
        } catch (InvocationTargetException e2) {
            Logger logger2 = Fabric.getLogger();
            logger2.w(CrashlyticsCore.TAG, "Cannot invoke method: " + str, e2);
            return false;
        } catch (IllegalAccessException e3) {
            Logger logger3 = Fabric.getLogger();
            logger3.w(CrashlyticsCore.TAG, "Cannot access method: " + str, e3);
            return false;
        }
    }
