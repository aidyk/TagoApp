...
public final class Util {
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String str;
        if (httpUrl.host().contains(SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR)) {
            str = "[" + httpUrl.host() + "]";
        } else {
            str = httpUrl.host();
        }
        ...
        return str + SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR + httpUrl.port();
    }
        ...
        while (true) {
            if (i >= i2) {
                ...
                if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                    if (i3 != 0) {
                        if (str.regionMatches(i, SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR, 0, 1)) {
                            i++;
