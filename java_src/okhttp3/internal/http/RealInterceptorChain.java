...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public Interceptor.Chain withConnectTimeout(int i, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, (long) i, timeUnit), this.readTimeout, this.writeTimeout);
    }
    ...
    public Interceptor.Chain withReadTimeout(int i, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, (long) i, timeUnit), this.writeTimeout);
    }
    ...
    public Interceptor.Chain withWriteTimeout(int i, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, this.readTimeout, Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, (long) i, timeUnit));
    }
