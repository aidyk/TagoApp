...
public class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(cls.getMethod("put", SSLSocket.class, cls2), cls.getMethod("get", SSLSocket.class), cls.getMethod(ProductAction.ACTION_REMOVE, SSLSocket.class), cls3, cls4);
