...
public final class Http2Codec implements HttpCodec {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(HttpRequest.HEADER_CONTENT_TYPE), HttpHeaders.contentLength(response), Okio.buffer(new StreamFinishingSource(this.stream.getSource())));
    }
