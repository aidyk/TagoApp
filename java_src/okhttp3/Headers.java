...
public final class Headers {
    ...
    public static final class Builder {
        ...
        public Builder addLenient(String str) {
            int indexOf = str.indexOf(SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR, 1);
            if (indexOf != -1) {
                return addLenient(str.substring(0, indexOf), str.substring(indexOf + 1));
            }
            if (str.startsWith(SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR)) {
        ...
        public Builder add(String str) {
            int indexOf = str.indexOf(SchemeUtil.DEFAULT_KEY_VALUE_SEPARATOR);
            if (indexOf != -1) {
