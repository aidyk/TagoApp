...
public final class Observables$zip$9<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
    final /* synthetic */ kotlin.jvm.functions.Function8 $combineFunction;

    public Observables$zip$9(kotlin.jvm.functions.Function8 function8) {
