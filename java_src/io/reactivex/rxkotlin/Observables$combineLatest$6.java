...
public final class Observables$combineLatest$6<T1, T2, T3, T4, T5, R> implements Function5<T1, T2, T3, T4, T5, R> {
    final /* synthetic */ kotlin.jvm.functions.Function5 $combineFunction;

    public Observables$combineLatest$6(kotlin.jvm.functions.Function5 function5) {
