...
public final class Flowables$combineLatest$3<T1, T2, T3, R> implements Function3<T1, T2, T3, R> {
    final /* synthetic */ kotlin.jvm.functions.Function3 $combineFunction;

    public Flowables$combineLatest$3(kotlin.jvm.functions.Function3 function3) {
