...
public final class Observables$zip$7<T1, T2, T3, T4, T5, T6, R> implements Function6<T1, T2, T3, T4, T5, T6, R> {
    final /* synthetic */ kotlin.jvm.functions.Function6 $combineFunction;

    public Observables$zip$7(kotlin.jvm.functions.Function6 function6) {
