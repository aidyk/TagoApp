...
public final class Observables$zip$8<T1, T2, T3, T4, T5, T6, T7, R> implements Function7<T1, T2, T3, T4, T5, T6, T7, R> {
    final /* synthetic */ kotlin.jvm.functions.Function7 $combineFunction;

    public Observables$zip$8(kotlin.jvm.functions.Function7 function7) {
