...
public final class Observables$zip$10<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
    final /* synthetic */ kotlin.jvm.functions.Function9 $combineFunction;

    public Observables$zip$10(kotlin.jvm.functions.Function9 function9) {
