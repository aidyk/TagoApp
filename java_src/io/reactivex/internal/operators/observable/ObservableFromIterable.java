...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        public void run() {
            while (!isDisposed()) {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.f10it.next(), "The iterator returned a null value"));
                    if (!isDisposed()) {
                        try {
        ...
        public T poll() {
            ...
            return (T) ObjectHelper.requireNonNull(this.f10it.next(), "The iterator returned a null value");
        }
