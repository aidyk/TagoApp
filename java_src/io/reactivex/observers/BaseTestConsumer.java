...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    public final U assertValues(T... tArr) {
        ...
        throw fail("Value count differs; Expected: " + tArr.length + StringUtils.SPACE + Arrays.toString(tArr) + ", Actual: " + size + StringUtils.SPACE + this.values);
    }
    ...
    public final U awaitCount(int i) {
        return awaitCount(i, TestWaitStrategy.SLEEP_10MS, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
    }

    public final U awaitCount(int i, Runnable runnable) {
        return awaitCount(i, runnable, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
    }
