...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    /* JADX DEBUG: Type inference failed for r2v2. Raw type applied. Possible types: io.reactivex.Maybe<R>, io.reactivex.Maybe<U> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U> Maybe<U> cast(Class<? extends U> cls) {
        ObjectHelper.requireNonNull(cls, "clazz is null");
        return (Maybe<R>) map(Functions.castFunction(cls));
    }
