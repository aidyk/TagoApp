...
public class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private AppSettingsData buildAppDataFrom(JSONObject jSONObject) throws JSONException {
        return new AppSettingsData(jSONObject.getString(SettingsJsonConstants.APP_IDENTIFIER_KEY), jSONObject.getString("status"), jSONObject.getString("url"), jSONObject.getString(SettingsJsonConstants.APP_REPORTS_URL_KEY), jSONObject.getString(SettingsJsonConstants.APP_NDK_REPORTS_URL_KEY), jSONObject.optBoolean(SettingsJsonConstants.APP_UPDATE_REQUIRED_KEY, false), (!jSONObject.has(SettingsJsonConstants.APP_ICON_KEY) || !jSONObject.getJSONObject(SettingsJsonConstants.APP_ICON_KEY).has(SettingsJsonConstants.ICON_HASH_KEY)) ? null : buildIconDataFrom(jSONObject.getJSONObject(SettingsJsonConstants.APP_ICON_KEY)));
    }
