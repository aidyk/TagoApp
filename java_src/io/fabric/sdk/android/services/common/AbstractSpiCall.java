...
public abstract class AbstractSpiCall {
    ...
    public HttpRequest getHttpRequest(Map<String, String> map) {
        ...
        return connectTimeout.header("User-Agent", CRASHLYTICS_USER_AGENT + this.kit.getVersion()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
