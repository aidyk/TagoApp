...
public final class SlidingWindowKt {
    ...
    @NotNull
    public static final <T> Iterator<List<T>> windowedIterator(@NotNull Iterator<? extends T> it2, int i, int i2, boolean z, boolean z2) {
        Intrinsics.checkParameterIsNotNull(it2, "iterator");
        if (!it2.hasNext()) {
            return EmptyIterator.INSTANCE;
        }
        return SequencesKt.iterator(new SlidingWindowKt$windowedIterator$1(i2, i, it2, z2, z, null));
    }
}
