...
public enum CharCategory {
    ...
    private static final Lazy categoryMap$delegate = LazyKt.lazy(CharCategory$Companion$categoryMap$2.INSTANCE);
    @NotNull
    ...
    public static final class Companion {
        static final /* synthetic */ KProperty[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(Companion.class), "categoryMap", "getCategoryMap()Ljava/util/Map;"))};
