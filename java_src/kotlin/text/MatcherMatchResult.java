...
public final class MatcherMatchResult implements MatchResult {
    ...
    public IntRange getRange() {
        java.util.regex.MatchResult matchResult2 = this.matchResult;
        Intrinsics.checkExpressionValueIsNotNull(matchResult2, "matchResult");
        return RegexKt.access$range(matchResult2);
    }
    ...
    public MatchResult next() {
        ...
        if (end <= this.input.length()) {
            return RegexKt.access$findNext(this.matcher, end, this.input);
        }
        return null;
    }
}
