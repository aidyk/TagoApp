...
class SequenceBuilderKt__SequenceBuilderKt {
    ...
    @NotNull
    public static final <T> Sequence<T> buildSequence(@BuilderInference @NotNull Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
