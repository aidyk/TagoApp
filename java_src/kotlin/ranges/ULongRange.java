...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m355containsVKZWuLQ(uLong.m195unboximpl());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getStart() {
        return ULong.m148boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getEndInclusive() {
        return ULong.m148boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m355containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m154constructorimpl(getFirst() ^ ULong.m154constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m154constructorimpl(getLast() ^ ULong.m154constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    @NotNull
    public String toString() {
        return ULong.m148boximpl(getFirst()) + ".." + ULong.m148boximpl(getLast());
    }
