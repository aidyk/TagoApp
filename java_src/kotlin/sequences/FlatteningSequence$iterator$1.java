...
public final class FlatteningSequence$iterator$1 implements Iterator<E>, KMappedMarker {
    ...
    private final boolean ensureItemIterator() {
        ...
        while (this.itemIterator == null) {
            ...
            Iterator<? extends E> it3 = (Iterator) FlatteningSequence.access$getIterator$p(this.this$0).invoke(FlatteningSequence.access$getTransformer$p(this.this$0).invoke(this.iterator.next()));
            if (it3.hasNext()) {
