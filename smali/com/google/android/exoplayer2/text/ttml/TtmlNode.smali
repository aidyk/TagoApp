...
.method public getCues(JLjava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    .line 178
    invoke-direct {p0, p3, v6}, Lcom/google/android/exoplayer2/text/ttml/TtmlNode;->traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p3}, Lcom/google/android/exoplayer2/text/ttml/TtmlNode;->cleanUpText(Landroid/text/SpannableStringBuilder;)Landroid/text/SpannableStringBuilder;

    move-result-object v2

    const/4 v3, 0x0

    iget v4, v0, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->line:F

    iget v5, v0, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->lineType:I

    iget v6, v0, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->lineAnchor:I

    iget v7, v0, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->position:F

    const/high16 v8, -0x80000000

    iget v9, v0, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->width:F
