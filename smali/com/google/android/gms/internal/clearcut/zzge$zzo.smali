...
.method protected final zza(ILjava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string/jumbo p2, "zzxw"

    aput-object p2, p1, v0

    const/4 p2, 0x2

    const-string/jumbo p3, "zzxz"

    aput-object p3, p1, p2

    const/4 p2, 0x3

    const-string/jumbo p3, "zzye"
    ...
    const-string/jumbo p3, "zzyf"

    aput-object p3, p1, p2

    const/4 p2, 0x6

    const-string/jumbo p3, "zzyh"

    aput-object p3, p1, p2

    const/4 p2, 0x7

    const-string/jumbo p3, "zzyk"

    aput-object p3, p1, p2

    const/16 p2, 0x8

    const-string/jumbo p3, "zzyi"

    aput-object p3, p1, p2

    const/16 p2, 0x9

    const-string/jumbo p3, "zzyg"

    aput-object p3, p1, p2

    const/16 p2, 0xa

    const-string/jumbo p3, "zzyd"

    aput-object p3, p1, p2

    const/16 p2, 0xb

    const-string/jumbo p3, "zzya"

    aput-object p3, p1, p2

    const/16 p2, 0xc

    const-string/jumbo p3, "zzyc"

    aput-object p3, p1, p2

    const/16 p2, 0xd

    const-string/jumbo p3, "zzyj"

    aput-object p3, p1, p2

    const/16 p2, 0xe

    const-string/jumbo p3, "zzyl"

    aput-object p3, p1, p2

    const/16 p2, 0xf

    const-string/jumbo p3, "zzym"

    aput-object p3, p1, p2

    const/16 p2, 0x10

    const-string/jumbo p3, "zzyn"

    aput-object p3, p1, p2

    const/16 p2, 0x11

    const-string/jumbo p3, "zzxx"

    aput-object p3, p1, p2

    const/16 p2, 0x12

    const-string/jumbo p3, "zzyo"

    aput-object p3, p1, p2

    const/16 p2, 0x13

    const-string/jumbo p3, "zzyq"
    ...
    const-string/jumbo p3, "zzyr"

    aput-object p3, p1, p2

    const/16 p2, 0x16

    const-string/jumbo p3, "zzxy"

    aput-object p3, p1, p2

    const/16 p2, 0x17

    const-string/jumbo p3, "zzys"

    aput-object p3, p1, p2

    const/16 p2, 0x18

    const-string/jumbo p3, "zzyt"

    aput-object p3, p1, p2

    const/16 p2, 0x19

    const-string/jumbo p3, "zzyp"

    aput-object p3, p1, p2

    const/16 p2, 0x1a

    const-string/jumbo p3, "zzyu"

    aput-object p3, p1, p2

    const/16 p2, 0x1b

    const-string/jumbo p3, "zzyb"
