...
.method protected final zza(ILjava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string/jumbo p3, "zzuo"

    aput-object p3, p1, p2

    const/4 p2, 0x4

    const-string/jumbo p3, "zzup"

    aput-object p3, p1, p2

    const/4 p2, 0x5

    const-string/jumbo p3, "zzuq"

    aput-object p3, p1, p2

    const/4 p2, 0x6

    const-string/jumbo p3, "zzur"

    aput-object p3, p1, p2

    const/4 p2, 0x7

    const-string/jumbo p3, "zzum"

    aput-object p3, p1, p2

    const/16 p2, 0x8

    const-string/jumbo p3, "zzun"

    aput-object p3, p1, p2

    const/16 p2, 0x9

    const-string/jumbo p3, "zzus"

    aput-object p3, p1, p2

    const/16 p2, 0xa

    const-string/jumbo p3, "zzuw"

    aput-object p3, p1, p2

    const/16 p2, 0xb

    const-string/jumbo p3, "zzut"

    aput-object p3, p1, p2

    const/16 p2, 0xc

    const-string/jumbo p3, "zzux"

    aput-object p3, p1, p2

    const/16 p2, 0xd

    const-string/jumbo p3, "zzuz"

    aput-object p3, p1, p2

    const/16 p2, 0xe

    const-string/jumbo p3, "zzuu"

    aput-object p3, p1, p2

    const/16 p2, 0xf

    const-string/jumbo p3, "zzuy"

    aput-object p3, p1, p2

    const/16 p2, 0x10

    const-string/jumbo p3, "zzuv"
